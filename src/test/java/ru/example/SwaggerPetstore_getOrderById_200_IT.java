 ...
 * @since 2020-08-13
 */
public class SwaggerPetstore_getOrderById_200_IT extends TestNGCitrusSupport {
    @CitrusTest
    @Test(
            enabled = false
    )
    @Parameters("runner")
    public void swaggerPetstore_getOrderById_200_IT(
            @CitrusResource @Optional TestCaseRunner runner) {
        runner.run(echo("TODO: Code the test SwaggerPetstore_getOrderById_200_IT"));
