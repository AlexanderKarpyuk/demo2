 ...
 * @since 2020-08-13
 */
public class SwaggerPetstore_loginUser_200_IT extends TestNGCitrusSupport {
    @CitrusTest
    @Test(
            enabled = false
    )
    @Parameters("runner")
    public void swaggerPetstore_loginUser_200_IT(@CitrusResource @Optional TestCaseRunner runner) {
        runner.run(echo("TODO: Code the test SwaggerPetstore_loginUser_200_IT"));
