 ...
 * @since 2020-08-13
 */
public class SwaggerPetstore_updatePet_400_IT extends TestNGCitrusSupport {
    @CitrusTest
    @Test(
            enabled = false
    )
    @Parameters("runner")
    public void swaggerPetstore_updatePet_400_IT(@CitrusResource @Optional TestCaseRunner runner) {
        runner.run(echo("TODO: Code the test SwaggerPetstore_updatePet_400_IT"));
